...
updatedAtUtc: 2026-02-12T06:35:46Z
```
...
## Next steps (M1)
- ✅ Tiny paired example added: deterministic + stochastic SEIR feed the same observation model and return `TimeSeriesDataset` objects (`diff_epi_inference.examples.make_paired_seir_reported_datasets`).
