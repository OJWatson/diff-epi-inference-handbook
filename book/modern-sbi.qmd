...
This handbook currently focuses on NPE as the first runnable baseline; NLE is a natural next step once
we have a comfortable conditional density model for the observation space (or summary space).
...
## End-to-end example (offline, deterministic)

If you want a single self-contained template you can run without optional JAX dependencies, see:

- [Modern SBI: an offline, deterministic end-to-end example](modern-sbi-end-to-end.qmd)
