...
This is intentionally scoped to the `beta`-only demo so we can keep the path
self-contained.
...
With [ArviZ](https://python.arviz.org/en/stable/) we can compute these summaries with a few lines.
