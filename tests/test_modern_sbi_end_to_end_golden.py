...
def test_modern_sbi_end_to_end_golden_outputs() -> None:
    ...
    assert float(np.quantile(beta_post, 0.1)) == pytest.approx(0.29254098493715425, rel=1e-10, abs=1e-12)
    assert float(np.quantile(beta_post, 0.9)) == pytest.approx(0.4189537197061017, rel=1e-10, abs=1e-12)
